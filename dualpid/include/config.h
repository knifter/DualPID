...
#define INPUTDRV_SHT31_ENABLED
#define INPUTDRV_M5KMETER_ENABLED
#define INPUTDRV_MCP9600_ENABLED
#define INPUTDRV_MAX31865_ENABLED
#define INPUTDRV_MLX90614_ENABLED
#define INPUTDRV_SPRINTIR_ENABLED
// #define SPRINTIR_PRESSURE_MBAR		1200		// 100mbar overpressure is assumed

#define OUTPUTDRV_GP8413_ENABLED
#define OUTPUTDRV_M5UNIT_SSR_ENABLED
#define OUTPUTDRV_M5UNIT_HBRIDGE_ENABLED
